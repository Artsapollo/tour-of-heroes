...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    ...
    getHero(id: number): Observable<Hero> {
      const url = `${this.heroesUrl}/by-id/${id}`;
  ...
  searchHeroes(term: string): Observable<Hero[]> {
    ...
    return this.http.get<Hero[]>(`${this.heroesUrl}/by-name/${term}`).pipe(
      tap(x => x.length ?
  ...
  addHero(hero: Hero): Observable<Hero> {
    return this.http.post<Hero>(`${this.heroesUrl}/create/${hero.name}`, this.httpOptions)
      .pipe(
